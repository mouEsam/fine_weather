...
@HiltViewModel
class MapPlacesViewModel @Inject constructor(private val placesRepository: MapPlacesRepository) : ViewModel() {

    private var job: Job? = null
    private val _uiState = MutableStateFlow<UiState<List<AutocompletePrediction>>>(UiState.Loaded(listOf()))
    ...
    fun getPredictions(address: String) {
        ...
        job = viewModelScope.launch {
            ...
            val result = placesRepository.getPredictions(address)
